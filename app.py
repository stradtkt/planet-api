...
def db_seed():
    mercury = Planet(planet_name="Mercury", planet_type='Class D', home_star='Sol', mass=3.258e23, radius=1516,
                     distance=35.98e26)
    venus = Planet(planet_name="Venus", planet_type='Class K', home_star='Sol', mass=4.867e24, radius=760,
                   distance=47.24e26)
    ...
    test_user = User(first_name="Kevin", last_name="Stradtman", email='stradtkt22@gmail.com', password='12345')
